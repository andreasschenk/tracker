CREATE DATABASE  IF NOT EXISTS `trackerv2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `trackerv2`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: trackerv2
-- ------------------------------------------------------
...
CREATE TABLE `user` (
  ...
  `sex` varchar(12) COLLATE latin1_general_ci NOT NULL DEFAULT 'thing',
...
-- Dump completed on 2024-05-26 16:07:13
